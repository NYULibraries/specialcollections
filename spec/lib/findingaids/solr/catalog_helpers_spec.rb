...
describe Findingaids::Solr::CatalogHelpers do
  ...
  describe ".facet_fields" do
    ...
    context "when looking at the field label values" do
      ...
      it { should eql ["Library", "Digital Content", "Creator", "Date Range", "Subject", "Name", "Place", "Language", "Collection", "Level"] }
    end
  end
  ...
  describe ".bq_fields" do
    ...
    it { should eql ["format_sim:\"Archival Collection\"^250", "level_sim:series^150", "level_sim:subseries^50", "level_sim:file^20", "level_sim:item"] }
  end
