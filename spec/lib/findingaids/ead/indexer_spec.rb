...
describe Findingaids::Ead::Indexer do
  ...
  describe '#update_or_delete' do
    before {
      allow_any_instance_of(Findingaids::Ead::Indexer).to receive(:update).and_return(true)
      allow_any_instance_of(Findingaids::Ead::Indexer).to receive(:delete).and_return(true)
    }
  ...
  describe '#reindex_changed_since_last_commit' do
    before {
      allow_any_instance_of(Findingaids::Ead::Indexer).to receive(:reindex_changed).and_return(true)
    }
  ...
  describe '#reindex_changed' do
    before {
      allow_any_instance_of(Findingaids::Ead::Indexer).to receive(:update_or_delete).and_return(true)
    }
