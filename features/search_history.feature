...
Scenario: Can clear search history
  Given I am on the default search page
  When I search on the phrase "Ramdasha"
  And I search on the phrase "Kimchi"
  And I click on the "Search History" link
...
Scenario: Searches can be added to saved searches
  Given I am on the default search page
  When I search on the phrase "Ramdasha"
  And I click on the "Search History" link
...
Scenario: Can clear saved searches
  Given I am on the default search page
  When I search on the phrase "Ramdasha"
  And I click on the "Search History" link
  And I click on the "save" button
