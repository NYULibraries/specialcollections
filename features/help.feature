Feature: Need Help?
  In order to better understand the types of searches I can perform
  As an advanced archival user
  I would like to view search tips and find information about how to contact repositories.
