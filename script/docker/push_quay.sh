...
docker tag specialcollections_cron quay.io/nyulibraries/specialcollections_cron:${CIRCLE_BRANCH//\//_}
docker tag specialcollections_cron quay.io/nyulibraries/specialcollections_cron:${CIRCLE_BRANCH//\//_}-${CIRCLE_SHA1}
docker tag specialcollections_cron quay.io/nyulibraries/specialcollections_cron:latest
...
docker push quay.io/nyulibraries/specialcollections_cron:${CIRCLE_BRANCH//\//_}
docker push quay.io/nyulibraries/specialcollections_cron:${CIRCLE_BRANCH//\//_}-${CIRCLE_SHA1}
docker push quay.io/nyulibraries/specialcollections_cron:latest
