module BlacklightHelper
  ...
  def should_show_index_field? document, field, solr_fname
    return (Findingaids::EadBehaviors::DEFAULT_INDEX_FIELDS.include? solr_fname or (!controller.controller_name.eql? "bookmarks" and document.has_highlight_field? solr_fname))
  end
