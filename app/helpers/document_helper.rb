module DocumentHelper
  ...
  def render_series_facet_link(args)
    ...
    series.each do |ser|
      links_to_series << link_to(ser, add_multiple_facet_params_and_redirect([[series_facet, ser],[collection_facet, collection]]).merge(sort_by_series))
    end
  ...
  def render_components_for_series_facet_link(doc)
    ...
    add_multiple_facet_params_and_redirect([[series_facet, title],[collection_facet, collection]]).merge(sort_by_series)
  end
  ...
  def render_collection_facet_link(args)
    ...
    local_params = add_multiple_facet_params_and_redirect([[collection_facet, item],[format_facet,"Archival Collection"]])
  ...
  def add_multiple_facet_params_and_redirect(fields)
  ...
  def add_clean_facet_params_and_redirect(field, item)
    new_params = reset_facet_params(params)
    new_params = add_facet_params(field, item, new_params)
